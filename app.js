...
db.serialize(() => {
  ...
  db.run(
    ...
    LOGIN_TIME_STAMP TIME, Game_start_time TIME, LOGOUT_TIME_STAMP TIME, Primary_Registration_Date TEXT, Secondary_Registration_Date Time, ACTIVE_DURATION INTEGER, 
